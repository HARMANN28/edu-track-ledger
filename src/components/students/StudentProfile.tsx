              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm">{student.currentAddress}</p>
                  </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">{student.fatherContact}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Mail className="h-4 w-4 text-muted-foreground" />
                      <span className="text-sm">{student.fatherEmail}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="flex items-center gap-2">
                      <Phone className="h-4 w-4 text-muted-foreground" />
                      <span className="text-sm">{student.motherContact}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Mail className="h-4 w-4 text-muted-foreground" />
                      <span className="text-sm">{student.motherEmail}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
